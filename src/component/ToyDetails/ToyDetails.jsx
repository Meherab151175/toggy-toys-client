      ...
      <div className="flex-grow  card w-[50%] bg-base-100 shadow-2xl mx-auto py-4">
        ...
        <div className="card-body">
          ...
          <div className="flex gap-10">
                <h2 className="border-2 border-slate-900 px-1 text-stone-950">{toy?.sellerName}</h2>
                <h2 className="border-2 border-slate-900 px-1 text-stone-950">{toy?.sellerEmail}</h2>
          </div>
